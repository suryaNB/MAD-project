...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionTable() {
        ...
        insertQuestion(q1);
        Question q2 = new Question("HTML stands for ","Hyper Text Markup Language",
                "Hyper Tech Markup Language", "none of the above", 1, Question.DIFFICULTY_EASY , Category.HTML);
        insertQuestion(q2);
        Question qnew3 = new Question("How to create an ordered list in HTML? ","<ul>",
                "<ol>", "none of the above", 2, Question.DIFFICULTY_EASY , Category.HTML);
        insertQuestion(qnew3);
        ...
        insertQuestion(q4);
        Question q5 = new Question("HTML tags are surrounded by _____ brackets.","Square",
                "Angular", "Round", 2, Question.DIFFICULTY_HARD , Category.HTML);
        insertQuestion(q5);
        ...
        insertQuestion(q60);
        //C
        Question q61 = new Question("How are strings represented in memory of C ?", "Array of characters",
                "Object of same class", "Linked List of characters", 1, Question.DIFFICULTY_EASY , Category.C);
        insertQuestion(q61);
        Question q62 = new Question("Which of the following is an exit controlled loop ?","while loop",
                "for loop", "do-while loop", 3, Question.DIFFICULTY_EASY , Category.C);
        insertQuestion(q62);
        Question q63 = new Question(" What is the size of int datatype in C (in bytes) ?","4",
                "8", "1", 1, Question.DIFFICULTY_EASY , Category.C);
        insertQuestion(q63);
        Question q64 = new Question("What is #include<stdio.h> ?","Inclusion directive",
                "Preprocessor directive", "File inclusion directive", 2, Question.DIFFICULTY_MEDIUM , Category.C);
        insertQuestion(q64);
        Question q65 = new Question("In C Language, FILE is of which data type ?","int",
                "char *", "struct", 3, Question.DIFFICULTY_MEDIUM , Category.C);
        insertQuestion(q65);
        Question q66 = new Question("scanf() is a pre-defined function in which header file ?","stdlib.h",
                "stdio.h", "ctype.h", 2, Question.DIFFICULTY_MEDIUM , Category.C);
        insertQuestion(q66);
        Question q67 = new Question("How many number of pointer (*) does C have against a pointer variable declaration? ?","127",
                "126", "No limits", 3, Question.DIFFICULTY_HARD , Category.C);
        insertQuestion(q67);
    }
